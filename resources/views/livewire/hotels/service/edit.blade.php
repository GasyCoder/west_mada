<div class="col-lg-4">
    <div class="card card-bordered h-100">
        <div class="card-inner">
            ...
            <form>
                <div class="mb-3">
                    <label class="form-label" for="full-name">Nom de Service</label>
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            @if ($is_active)
                                <input type="checkbox" class="custom-control-input" checked wire:model="is_active" id="customSwitch{{$serviceId}}">
                                <label class="custom-control-label text-success" for="customSwitch{{$serviceId}}">
                                    Activer
                                </label>
                                @else
                                <input type="checkbox" class="custom-control-input" wire:model="is_active" id="customSwitch{{$serviceId}}">
                                <label class="custom-control-label text-success" for="customSwitch{{$serviceId}}">
                                    Activer
                                </label>
                            @endif
