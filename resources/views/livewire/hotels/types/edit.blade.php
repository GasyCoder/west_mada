<div class="col-lg-4">
    <div class="card card-bordered h-100">
        <div class="card-inner">
            ...
            <form>
                <div class="mb-3">
                    <label class="form-label" for="full-name">Type de chambre</label>
                    <input type="text" class="form-control" id="name" wire:model="name" placeholder="Saisir le type">
                    <div>
                    ...
                    <div class="form-group">
                        <div class="custom-control custom-switch">
                            ...
                            <input type="checkbox" class="custom-control-input" checked wire:model="is_active"
                                id="customSwitch{{$typeId}}">
                            <label class="custom-control-label text-success" for="customSwitch{{$typeId}}">
                                Activer
                            </label>
                            @else
