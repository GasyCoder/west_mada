            ...
            <div class="card-inner p-0">
                <div class="nk-tb-list nk-tb-ulist">
                    <div class="nk-tb-item nk-tb-head">
                        <div class="nk-tb-col tb-col-md"><span class="sub-text">Réference</span></div>
                        <div class="nk-tb-col tb-col-md"><span class="sub-text"></span></div>
                        <div class="nk-tb-col"><span class="sub-text">Client <em class="icon ni ni-user-alt-fill"></em></span></div>
                                ...
                                <ul class="link-tidy sm no-bdr">
                                    <li>
                                        <div class="custom-control custom-control-sm custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="vri" wire:click="toggleConfirmed">
                                            <label class="custom-control-label" for="vri">Payée</label>
                                        </div>
                                    </li>   
                                    <li>
                                        <div class="custom-control custom-control-sm custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="st" wire:click="togglePending">
                                            <label class="custom-control-label" for="st">En attente</label>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div class="nk-tb-item">
                        ...
                        <div class="nk-tb-col">
                            <a href="" class="sub-text tb-lead">
                                <b><em class="icon ni ni-building-fill sm"></em>
                                    {{$reservation->hotel->room_number}}</b> -
                        ...
                        <div class="user-card">
                            ...
                            @else
                            <div class="user-avatar sm bg-primary"><span>{{ substr($reservation->client_name, 0, 2) }}</span></div>
                            @endif
                            <div class="user-info">
                                ...
                                <li>
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            ...
                                            @can('booking-edit')
                                            <li>
                                                <a href="#EditBooking" wire:click="edit({{$reservation->id}})" data-bs-toggle="modal">
    ...
    <div class="p-3">
        <div class="alert alert-icon alert-warning" role="alert">
            ...
            <a href="/dashboard" wire:navigate class="btn btn-sm btn-primary text-end"><em class="icon ni ni-reload"></em></a>
        </div>
    </div>
    @endif
</div>
