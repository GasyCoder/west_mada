                        ...
                        <table class="table table-sm">
                                ...
                                <tr>
                                    ...
                                    <th>
                                        <div class="custom-control custom-control-sm custom-checkbox notext">
                                            <input type="checkbox" wire:model="checkedAll" class="custom-control-input"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="custom-control custom-control-sm custom-checkbox notext">
                                            <input type="checkbox" wire:model="checked" wire:click="countChecked()"
                                                class="custom-control-input" value="{{ $row->id }}"
                                                id="uid{{ $row->id }}">
                                    ...
                                    <td><small class="text-muted">{{ $row->created_at->format('d-M à H:i') }}</small>
                                    </td>
                                    {{-- <td class="nk-tb-col tb-col-lg">
                                        <span class="tb-lead">{{ $row->user->name }}</span>
                                        <div class="user-info">
                                            <small class="text-muted">
                                                @foreach ($row->user->services as $service)
                                                {{ $service->title }}
                                                @endforeach
                                            </small>
                                        </div>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group">
                                            <a data-bs-toggle="modal" href="#show-bon" class="btn btn-primary btn-sm"
                                        ...
                                        @can('period-edit')
                                        <div class="btn-group" role="group">
                                            <a data-bs-toggle="modal" href="#edit-bon" class="btn btn-info btn-sm"
