    ...
    p.ClassBody = function () {
            ...
            p.TGL.screen(n),
                ...
                l.on("mouseup", function (t) {
                    ...
                    s && (e = u(s),
                        ...
                        a = u(".datepicker-dropdown"),
                        i = u(".ui-timepicker-container"),
                        o = u(".modal"),
                        e.is(t.target) || 0 !== e.has(t.target).length || n.is(t.target) || 0 !== n.has(t.target).length || 0 !== u(t.target).closest(".select2-container").length || a.is(t.target) || 0 !== a.has(t.target).length || i.is(t.target) || 0 !== i.has(t.target).length || o.is(t.target) || 0 !== o.has(t.target).length || (p.Toggle.removed(e.data("target"), r),
                            s = !1))
                }),
                c.on("resize", function () {
                    n.each(function () {
        ...
        p.TGL.showmenu = function (t, e) {
            ...
            n.on("click", function (t) {
                ...
                c.on("resize", function () {
                    (p.Win.width < d.xl || p.Win.width < i) && !p.State.isMobile && p.Toggle.removed(n.data("target"), o)
                })
        }
        ,
        ...
        p.Preloader = function () {
            var t = u(".js-preloader");
            t.exists() && (a.addClass("page-loaded"),
                t.delay(600).fadeOut(300))
        }
        ,
